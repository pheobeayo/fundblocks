    ...
    return (
        <main class='bg-[#121113] w-screen'>
            ...
            <div class='grid grid-cols-1 md:flex md:flex-row gap-2'>
                <div>
                    <h1 className="text-[60px] md:text-[60px] font-bold capitalize  text-white mx-10 mt-8 ">Revolutionizing Tech
                    ...
                    <div className="flex item-centre gap-8  mx-8 mt-4">
                        ...
                        <Link to='/create-project'><button class="text-black bg-gradient-to-r from-[#69FEB0] to-[#5DE4F7] hover:bg-[#5DE4F7] focus:ring-4 focus:ring-blue-300 font-bold rounded-lg text-sm px-5 py-2.5 dark:bg-[#69FEB0] dark:hover:bg-[#69FEB0] focus:outline-none dark:focus:ring-[#69FEB0]">
